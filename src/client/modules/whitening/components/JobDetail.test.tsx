...
describe("whitening JobDetail log", () => {
  it("collapses consecutive lines from the same step into one group", () => {
    render(<JobDetail job={makeJob()} onStop={() => {}} onResolvePreserve={() => {}} />);
  ...
  it("leaves the last step open while the job is still running, closed once completed", () => {
    const { unmount } = render(<JobDetail job={makeJob({ status: "in-progress" })} onStop={() => {}} onResolvePreserve={() => {}} />);
    ...
    render(<JobDetail job={makeJob({ status: "completed" })} onStop={() => {}} onResolvePreserve={() => {}} />);
  ...
  it("opens the failing step so the error is visible without a click", () => {
    render(<JobDetail job={makeJob({ status: "failed", errorMessage: "boom" })} onStop={() => {}} onResolvePreserve={() => {}} />);
  ...
  it("shows the empty state rather than an empty group list", () => {
    render(<JobDetail job={makeJob({ log: [] })} onStop={() => {}} onResolvePreserve={() => {}} />);
